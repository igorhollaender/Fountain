    ...
    def TestSchedule():
        schedule = [
            ...
            ScheduledDeviceAction(1.0,
                                  ...
                                  kwargs={'device': FountainDeviceCollection.PUMP1,
                                          'pwm_percentage_begin': 0,
                                          'pwm_percentage_end': 100,
                                          'totalDuration': 20,
                                          'numberOfInterimSteps': 40,
                                          }),
            ScheduledDeviceAction(21.0,
                                  FountainDeviceCollection.PUMP1,
                                  FountainDevice.pwm_setLinearRamp,
                                  kwargs={'device': FountainDeviceCollection.PUMP1,
                                          'pwm_percentage_begin': 100,
                                          'pwm_percentage_end': 0,
                                          'totalDuration': 20,
                                          'numberOfInterimSteps': 40,
                                          }),
            ScheduledDeviceAction(10.0,
                                  FountainDeviceCollection.PUMP2,
                                  FountainDevice.pwm_setLinearRamp,
                                  kwargs={'device': FountainDeviceCollection.PUMP2,
                                          'pwm_percentage_begin': 0,
            ...
            ScheduledDeviceAction(5.0,
                                  ...
                                  kwargs={'device': FountainDeviceCollection.LED1,
                                          'pwm_percentage_low': 20,
                                          'pwm_percentage_high': 80,
                                          'numberOfHighPulses': 4,
                                          'duration_high': 2,
                                          'duration_low': 3,
                                          }),
